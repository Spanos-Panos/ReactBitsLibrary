...
function Images() {
  ...
  return (
    <group ref={group}>
      <Image position={[-2, 0, 0]} scale={[3, height / 1.1]} url="/joker-landscape.jpg" />
      <Image position={[2, 0, 3]} scale={3} url="/joker-square.jpg" />
      <Image position={[-2.05, -height, 6]} scale={[1, 3]} url="/joker-portrait.jpg" />
      <Image position={[-0.6, -height, 9]} scale={[1, 2]} url="/joker-landscape.jpg" />
      <Image position={[0.75, -height, 10.5]} scale={1.5} url="/joker-square.jpg" />
    </group>
  );
}
