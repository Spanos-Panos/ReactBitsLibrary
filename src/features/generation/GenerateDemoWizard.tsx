                      ...
                      {runWhenDone && (
                        ...
                        >
                          ...
                          <AutomationRow
                            ...
                            title="Fallback: auto-clear task on error"
                            subtext="If auto-run fails, close the task pill automatically"
                            checked={autoKillOnError}
                            onChange={onAutoKillOnErrorChange}
                            child
                          />
                        </motion.div>
                      )}
